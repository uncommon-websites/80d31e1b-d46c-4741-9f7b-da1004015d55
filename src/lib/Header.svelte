...
<header class="w-full bg-white text-gray-900 sticky top-0 z-50 transition-all duration-300">
  ...
  <div class="border-b border-gray-100 hidden md:block">
    <div class="max-w-[1600px] mx-auto px-6 h-10 flex justify-end items-center gap-6 text-[11px] font-medium tracking-wide text-gray-500 uppercase">
      <a href="#" class="hover:text-black transition-colors">Zürich</a>
      <a href="#" class="hover:text-black transition-colors">Contact</a>
      <button class="hover:text-black transition-colors flex items-center gap-1">De <span class="text-[8px]">▼</span></button>
      <button class="hover:text-black transition-colors flex items-center gap-1">CHF <span class="text-[8px]">▼</span></button>
    </div>
  </div>
  ...
  <div class="border-b border-gray-100">
    <div class="max-w-[1600px] mx-auto px-6 h-20 flex justify-between items-center relative">
      <!-- Logo -->
      <div class="w-32">
        <a href="/" class="flex items-center text-primary-700 hover:text-primary-800 transition-colors">
          ...
          <span class="ml-2 text-xl font-semibold tracking-tight">Vue AG</span>
        </a>
      </div>

      <!-- Center Nav -->
      <nav class="hidden md:flex items-center gap-10 text-[13px] font-medium tracking-wide uppercase">
        <a href="#portfolio" class="hover:text-primary-700 transition-colors">Portfolio</a>
        <a href="#process" class="hover:text-primary-700 transition-colors">Process</a>
        <a href="#founders" class="hover:text-primary-700 transition-colors">Team</a>
        <a href="#contact" class="hover:text-primary-700 transition-colors">Sell Your Property</a>
      </nav>

      <!-- Right Icons -->
      <div class="w-32 flex justify-end items-center gap-6">
        <a href="#contact" class="bg-primary-600 text-white px-4 py-2 text-xs uppercase tracking-widest hover:bg-primary-700 transition-colors">
          Contact
        </a>
      </div>
    </div>
  ...
  <!-- Sub Nav / Breadcrumb area -->
  <div class="border-b border-gray-100">
    <div class="max-w-[1600px] mx-auto px-6 h-12 flex justify-between items-center">
        <span class="text-[11px] uppercase tracking-wide font-medium text-gray-500">
            Building sustainable portfolios in Zürich
        </span>
        <a href="mailto:hello@vue.ag" class="text-[11px] uppercase tracking-wide font-medium text-gray-500 hover:text-black transition-colors">
            hello@vue.ag
        </a>
    </div>
  </div>

<header class="w-full bg-white text-gray-900 sticky top-0 z-50 border-b border-gray-100">
  <div class="max-w-[1600px] mx-auto px-6 h-20 flex justify-between items-center">
    ...
    <!-- Contact Button -->
    <a href="#contact" class="bg-primary-600 text-white px-6 py-3 text-sm hover:bg-primary-700 transition-colors">
      Contact
    </a>
  </div>
</header>
